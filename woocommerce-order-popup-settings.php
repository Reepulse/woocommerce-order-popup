...
function woocommerce_order_popup_settings()
{
    ...
    $content .= "<table id='settings-woocommerce-order-popup'>";
    $content .= "<form action='' method='post' id='notificationSettingsForm'>";
    $content .= "<tr><th>Filter order by id: </th><th><input type='number' min=0 name='inputForProductIds' placeholder='Please enter one by one'></th></tr>";
    $content .= "<tr><th>MP3 Url: </th><th><input type='text' name='inputForMp3' placeholder='".esc_html($options['mp3_url'])."'></th></tr>";
    //pending = 1, on-hold = 3, processing = 5, pending&on-hold = 4, pending&processing = 6, on-hold&processing = 8, pending&on-hold&processing = 9
    $content .= "<tr><th>Popup Order Statuses: </th><th>";
    ...
    if(count($product_ids))
    {
        ...
        $content .= "<table id='settings-woocommerce-order-popup'><form action='' method='post' id='notificationSettingsForm'> ";
