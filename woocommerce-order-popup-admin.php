...
add_action( 'admin_menu', 'woocommerce_order_popup' );

function woocommerce_order_popup() {
    add_menu_page( 'Woocommerce Order Popup', 'Woocommerce Order Popup', 'manage_woocommerce' , 'woocommerce_order_popup' , 'woocommerce_order_popup_menu', 'dashicons-warning' , '54');
	add_submenu_page('woocommerce_order_popup', 'Settings', 'Settings', 'manage_woocommerce', 'woocommerce_order_popup_settings', 'woocommerce_order_popup_settings');
}

function woocommerce_order_popup_menu()
{
    ...
    $content = "<h1>Woocommerce Order Popup for Woocommerce</h1>";
    $content .= "<table id='customers-woocommerce-order-popup'>";
